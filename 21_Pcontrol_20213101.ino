...
// Framework setting
#define _DIST_TARGET 205    // [20213085] 정지하려는 위치 목표값
...
// Servo range
#define _DUTY_MIN 1550    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1850    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 2150        // [20213081] 서보 각도의 최댓값
...
// PID parameters
#define _KP 1.3        //[20191979] 비례제어 값
...
// convert angle speed into duty change per interval.
  duty_chg_per_interval = int((_DUTY_MAX-_DUTY_MIN)*((float)_SERVO_SPEED/_SERVO_ANGLE)*(float(_INTERVAL_DIST)/1000.0)); //[20203118] duty_chg_per_interval 값 설정   
}
