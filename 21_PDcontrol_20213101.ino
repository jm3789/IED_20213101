...
// Framework setting
#define _DIST_TARGET 200    // [20213085] 정지하려는 위치 목표값
...
// Servo range
#define _DUTY_MIN 1500    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1800    // [20213090]서보 수평 각도 펄스 값
...
myservo.writeMicroseconds(duty_curr); //[20213086]
  ...
  if(event_serial) {
    ...
    Serial.println(",Min:100,Low:200,dist_target:200,High:310,Max:410");
  }
}
